...
function CreateProduct() {
 ...
 const handleCreate = async(e) => {
  ...
  <div className="mb-3">
    <input type="textarea" value={description} placeholder='write a description' className='form-control' onChange={(e)=>setDescription(e.target.value)} />
  </div>
  <div className="mb-3">
    <input type="text" value={price} placeholder='write a price' className='form-control' onChange={(e)=>setPrice(e.target.value)} />
  </div>
  <div className="mb-3">
    <input type="number" value={quantity} placeholder='write a quantiity' className='form-control' onChange={(e)=>setQuantity(e.target.value)} />
  </div>
  <div className="mb-3">
    <Select
    placeholder='select  shipping' className='form-select mb-3'  
    bordered={false} size="large" showSearch onChange={(value)=>{ setShipping(value)}} >
